...
if (isset($_POST['simpan'])) {
    if (tambah($_POST) > 0) {
        ...
        echo "<script>
                alert('Data Penumpang gagal ditambahkan!');
            </script>";
    }
}
...
<head>
     ...
     <title>Tambah Data Penumpang</title>
</head>
...
<body background="img/bg/kereta bg.jpg">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="kereta" name="kereta">
                                   ...
                                   <option value="Kamandaka">Kamandaka</option>
                                   <option value="Joglosemarkerto">Joglosemarkerto</option>
                                   <option value="Argo Bromo Anggrek">Argo Bromo Anggrek</option>
                                   <option value="Majapahit">Majapahit</option>
                                   <option value="Tawang Jaya Premium">Tawang Jaya Premium</option>
                              </select>
                         </div>
                         <div class="mb-3">
     ...
     gsap.to('.Tambah_data', {
          duration: 2,
          delay: 1,
          text: '<i class="bi bi-person-plus-fill"></i>Tambah Data Penumpang :)'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
