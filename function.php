<?php
// Koneksi Database
$koneksi = mysqli_connect("localhost", "root", "", "adminkereta");
...
function tambah($data)
{
    ...
    $sql = "INSERT INTO siswa VALUES ('$nik','$nama','$tmpt_Lahir','$tgl_Lahir','$jekel','$kereta','$email','$gambar','$alamat')";
...
function ubah($data)
{
    ...
    $sql = "UPDATE siswa SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', kereta = '$kereta', email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE nik = $nik";
