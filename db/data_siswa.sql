...
CREATE TABLE `siswa` (
  ...
  `kereta` enum('Kaligung','Kamandaka','Joglosemarkerto','Argo Bromo Anggrek','Majapahit','Tawang Jaya Premium') NOT NULL,
...
INSERT INTO `siswa` (`nik`, `nama`, `tmpt_Lahir`, `tgl_Lahir`, `jekel`, `kereta`, `email`, `gambar`, `alamat`) VALUES
