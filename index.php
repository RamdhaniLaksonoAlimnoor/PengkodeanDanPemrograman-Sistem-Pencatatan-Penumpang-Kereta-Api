...
// Menampilkan semua data dari table siswa berdasarkan nik secara Descending
$siswa = query("SELECT * FROM siswa ORDER BY nik DESC");
?>
<!DOCTYPE html>
<html lang="en">
...
<body background="img/bg/kereta bg.jpg">
     ...
     <div class="container">
          <div class="row my-2">
               <div class="col-md">
                    <h3 class="text-center fw-bold text-uppercase text-light data_penumpang">Data Penumpang</h3>
                    <hr>
               </div>
          </div>
          <div class="row my-2">
                                ...
                                ?>
                                   ...
                                   <td>
                                        <button class="btn btn-success btn-sm text-white detail"
                                             data-id="<?= $row['nik']; ?>" style="font-weight: 600;"><i
                                                  class="bi bi-info-circle-fill" data-aos="fade-right"
                                                  data-aos-duration="800"></i>Detail</button> |

                                        <a href="ubah.php?nik=<?= $row['nik']; ?>" class="btn btn-warning btn-sm"
                                             style="font-weight: 600;"><i class="bi bi-pencil-square"></i>Ubah</a> |

                                        <a href="hapus.php?nik=<?= $row['nik']; ?>" class="btn btn-danger btn-sm"
     ...
     <!-- Footer -->
     <div class="container-fluid" style="position: absolute; bottom: 0; width: 100%;margin-top: auto;">
